...
export const CONTENT_ITEMS_PER_PAGE = 300;
export const CONTENT_ITEMS_REDUNDANCE = 15;
//export const REST_WEB_SERVICE_URL = "http://techomaticsolutions.azurewebsites.net/shop/rest/index.php?";
export const REST_WEB_SERVICE_URL = "http://stil36/shop/rest/index.php?";
export const AZURE_SERVICE_URL = 'http://ionic-azure-rm.azurewebsites.net/'
/**
